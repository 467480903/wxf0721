...
用法:
    python set_reference_tag.py --size 97
    python set_reference_tag.py --size 97 --spacing 730        # 给实测值, 精度更高
    python set_reference_tag.py --size 97 --name A             # 命名基准
...
from AprilTag_pose import process_image
